...
| B站后台播放 - 快速隐藏视频 | 按 ` 键快速隐藏视频画面+模糊全页面，只保留音频播放，公共场合救星，支持音频控制面板和快捷键操作 | [本地脚本](bili-background-play.js) | <div style="max-height: 300px; overflow: auto;">即将添加预览图片</div> |
| B站/油管视频转Get笔记 | 一键将 Bilibili 或 YouTube 视频转换为Get笔记，自动提取视频信息并调用 Get Notes API | [本地脚本](get_note.js) | <div style="max-height: 300px; overflow: auto;">即将添加预览图片</div> |
